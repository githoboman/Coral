...
import {
  Copy, Check, LogOut, MessageSquare, Users, Bell,
...
export default function AppLayout() {
  ...
  const navItems: NavItem[] = [
    { name: 'Chats', to: '/c/', icon: 'messageSquare', active: location.pathname === '/c' || location.pathname === '/app' },
    { name: 'Agents', to: '/agents', icon: 'users', active: location.pathname === '/agents' },
    { name: 'Notifications', to: '/notifications', icon: 'bell', active: location.pathname === '/notifications' },
    { name: 'Settings', to: '/settings', icon: 'settings', active: location.pathname === '/settings' },
  ];
                ...
                <AnimatePresence mode="wait">
                  {isWalletCollapsed ? (
                    <motion.button
                      ...
                      className="h-fit p-4 bg-white/5 backdrop-blur-xl border border-white/10 rounded-[30px] flex items-center gap-2 text-white/60 hover:text-white transition-colors"
                    >
                      <Wallet size={20} />
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 w-full my-6">
                        ...
                        <button
                          ...
                          disabled={!address}
                          className={`ml-auto p-2 rounded-xl transition-all duration-200 flex items-center justify-center ${
                            copiedField === 'address'
