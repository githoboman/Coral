 ...
 *
 * Order is deliberate. The kill switch and the budget meters are above the
 * fold; the policy review is next; the history is last. Someone opening this
 * page in a hurry is far more likely to be worried than curious, and the
 * layout should serve the worried case first (FR-11.4).
 */
...
import { ApiError, corralApi, type ExecutionView, type SessionView } from "../lib/api";
...
export default function SessionDetail() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-8 px-4 py-8">
      ...
      {running ? (
        <section aria-label="Stop this agent">
          <KillSwitch sessionId={s.id} />
        </section>
      ) : null}
